...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("tonemap", { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/new_coords.vert.spv", VK_GRAPHICS_BASIC_ROOT "/resources/shaders/tonemap.frag.spv" });
}
...
void SimpleShadowmapRender::SetupSimplePipeline()
{
  ...
  m_toneMappingPipeline = pipelineManager.createGraphicsPipeline("tonemap",
    {
       .vertexShaderInput = {},
       .fragmentShaderOutput =
         {
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    ...
    etna::RenderTargetState renderTargets(a_cmdBuff, {0, 0, m_width, m_height},
      {{.image = tonemap.get(), .view = tonemap.getView({})}},
  ...
  //// draw tonemap to screen
  //
  {
    auto tonemapShader = etna::get_shader_program("tonemap");

    auto descriptor = etna::create_descriptor_set(
      tonemapShader.getDescriptorLayoutId(0),
      a_cmdBuff,
      { { 0, constants.genBinding() },
        { 1, tonemap.genBinding(defaultSampler.get(), vk::ImageLayout::eShaderReadOnlyOptimal) } });

    VkDescriptorSet vkSets[] = {descriptor.getVkSet() };

    etna::RenderTargetState renderTarget(a_cmdBuff,{ 0, 0, m_width, m_height},
    ...
    vkCmdBindDescriptorSets(a_cmdBuff, VK_PIPELINE_BIND_POINT_GRAPHICS, m_toneMappingPipeline.getVkPipelineLayout(), 0, 1, vkSets, 0, VK_NULL_HANDLE);
